      ...
      <Col style={{ marginTop: "50px" }}>
        <Card id="card-item">
          ...
          <div>
            ...
            <Card.Body>
              <Card.Subtitle style={{textAlign:'center',margin:'20px'}}>Type : {type}</Card.Subtitle>
              <Card.Subtitle style={{textAlign:'center',margin:'20px'}}>Prix : {prix} TND/jour </Card.Subtitle>
              {/* <Card.Text>Disponibilité : {disponibilite}</Card.Text> */}
              <Card.Subtitle style={{textAlign:'center',margin:'20px'}}>kilométrage : {kilometrage}</Card.Subtitle>
              {disponibilite ? (
